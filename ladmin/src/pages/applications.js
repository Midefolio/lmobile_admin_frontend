  ...
  {settings &&   <div className="add-item-modal" onClick={()=> {setSettings(false)}}>
   ...
   <div className="mother">
    <div className="my-col-10 off-1 down-10">
      <div className="mother">
        <div className="mother">
          <span className="px30 bold ">Welcome To L-<span className="color-code-1">Mobile</span> <span className="px13 faded">(Admin)</span></span>
          <span className="px13 fl-right bold pd-10 bg-faded rad-unset c-pointer black" onClick={()=> {setSettings(true)}}> <i className="fas fa-cog"></i> Account Settings</span>
        </div>
      </div>
      <div className="mother down-3"><span className="faded">Please Select an Application to Manage</span></div>
      <div className="mother down-3">
       <div className="my-col-4" onClick={()=> {history?.push('/c-panel')}}>
        <div className="my-col-10 down-3 my-bottom-50 b-shadow brad bg-color-code-2">
          <div className="my-col-10 off-1 down-10">
            <div><span className="px13 faded">Manage</span></div>
           <div className="mother down-2"><span className="px20 bold">Grocery Market</span></div>
           <div className="mother down-2 color-code-1"><span className="px13 bold">c-pannel</span></div>
          </div>
        </div>
       </div>
       <div className="my-col-4">
        <div className="my-col-10 down-3 my-bottom-50 b-shadow brad bg-color-code-2">
          <div className="my-col-10 off-1 down-10">
            <div><span className="px13 faded">Manage</span></div>
           <div className="mother down-2"><span className="px20 bold">Real-Estate Market</span></div>
           <div className="mother down-2 color-code-1"><span className="px13 bold">d-pannel</span></div>
          </div>
        </div>
       </div>
       <div className="my-col-4">
        <div className="my-col-10 down-3 my-bottom-50 b-shadow brad bg-color-code-2">
          <div className="my-col-10 off-1 down-10">
            <div><span className="px13 faded">Manage</span></div>
           <div className="mother down-2"><span className="px20 bold">HealthCare Market</span></div>
           <div className="mother down-2 color-code-1"><span className="px13 bold">e-pannel</span></div>
          </div>
        </div>
       </div>
      </div>
     <div className="mother down-6">
